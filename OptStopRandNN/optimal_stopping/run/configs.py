...
class _DefaultConfig:
  ...
  use_spot_as_input: Iterable[bool] = (True,)
  # electricity-model specific optional parameters (kept as iterables)
  rate: Iterable[float] = (0.02,)
  alpha: Iterable[float] = (7.0,)
  sigma: Iterable[float] = (1.4,)
  beta: Iterable[float] = (200.0,)
  lam: Iterable[float] = (4.0,)
  x0: Iterable[float] = (0.0,)
  y0: Iterable[float] = (0.0,)
  dist_par: Iterable[float] = (0.4,)
  f_level: Iterable[float] = (100.0,)
...
table_test = _VerySmallDimensionTable(
   drift=(0.0,), use_payoff_as_input=(True, False))

table_BS_MaxCallr0_small = _VerySmallDimensionTable(
   drift=(0.0,), use_payoff_as_input=(True, False))

#spots=[80, 100, 120]


table_BS_MaxCallr0_big = _BigDimensionTable(
   drift=(0.0,), use_payoff_as_input=(True, False))
...
# ------------------------------,use_spot_as_input=(False,)


table_electricity_small = _VerySmallDimensionTable(
...
#.venv\Scripts\python -m optimal_stopping.run.run_algo --configs=table_electricity_big --nb_jobs=10
